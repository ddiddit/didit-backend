            ...
            .andDo(
                document(
                    ...
                    responseFields(
                        ...
                        fieldWithPath("data.summary.summary").type(JsonFieldType.STRING).description("회고 요약"),
                        ...
                        fieldWithPath("data.summary.blockedPoint").type(JsonFieldType.ARRAY).description("막힌 지점"),
                        fieldWithPath("data.summary.solutionProcess").type(JsonFieldType.ARRAY).description("해결 과정"),
                        fieldWithPath("data.summary.lessonLearned").type(JsonFieldType.ARRAY).description("배운 점"),
                        fieldWithPath("data.summary.nextAction").type(JsonFieldType.ARRAY).description("다음 액션"),
                    ),
                ),
            )
    }
            ...
            .andDo(
                document(
                    ...
                    responseFields(
                        ...
                        fieldWithPath("data.summary.summary").type(JsonFieldType.STRING).description("회고 요약 문장").optional(),
                        ...
                        fieldWithPath("data.summary.blockedPoint").type(JsonFieldType.ARRAY).description("막힌 지점").optional(),
                        fieldWithPath("data.summary.solutionProcess").type(JsonFieldType.ARRAY).description("해결 과정").optional(),
                        fieldWithPath("data.summary.lessonLearned").type(JsonFieldType.ARRAY).description("배운 점").optional(),
                        fieldWithPath("data.summary.nextAction").type(JsonFieldType.ARRAY).description("다음 액션").optional(),
