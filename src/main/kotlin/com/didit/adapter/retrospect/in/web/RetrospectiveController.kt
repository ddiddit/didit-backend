package com.didit.adapter.retrospect.`in`.web

import com.didit.adapter.retrospect.`in`.web.request.StartRetrospectiveRequest
import com.didit.adapter.retrospect.`in`.web.request.SubmitAnswerRequest
import com.didit.adapter.retrospect.`in`.web.response.RetrospectiveResponse
import com.didit.adapter.retrospect.`in`.web.response.RetrospectiveSummaryResponse
import com.didit.adapter.retrospect.`in`.web.response.StartRetrospectiveResponse
import com.didit.adapter.retrospect.`in`.web.response.SubmitAnswerResponse
...
class RetrospectiveController(
    ...
    fun start(@RequestBody request: StartRetrospectiveRequest): StartRetrospectiveResponse {
        val result = startRetrospectiveUseCase.start(
    ...
    fun submitAnswer(
        ...
        val result = submitAnswerUseCase.submitAnswer(
            SubmitAnswerCommand(
    ...
    fun getResult(@PathVariable retrospectiveId: UUID): RetrospectiveResponse {
