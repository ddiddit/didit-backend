package com.didit.adapter.webapi.admin.resolver
...
@Component
class CurrentAdminIdResolver : HandlerMethodArgumentResolver {
    override fun supportsParameter(parameter: MethodParameter): Boolean =
        parameter.hasParameterAnnotation(CurrentAdminId::class.java) &&
